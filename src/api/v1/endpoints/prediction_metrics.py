...
async def get_prediction_metrics(
    ...
    days: int = Query(30, description="Número de días hacia atrás para obtener métricas (0 para desactivar filtro de fecha)", ge=0, le=365),
    ...
    # Filtro de fecha opcional: solo si days > 0
